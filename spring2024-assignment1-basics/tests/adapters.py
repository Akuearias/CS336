...
from ..cs336_basics import BPETokenizer, tokenizer_train, attention, positionwise_feedforward, RMSNorm, transformer_block, Transformer_LM, utils
...
def run_positionwise_feedforward(
    ...
    return positionwise_feedforward.run_positionwise_feedforward(d_model, d_ff, weights, in_features)
...
def run_scaled_dot_product_attention(
    ...
    """
    return attention.run_scaled_dot_product_attention(K, Q, V, mask, pdrop)
...
def run_multihead_self_attention(
    ...
    """
    return attention.run_multihead_self_attention(d_model, num_heads, attn_pdrop, weights, in_features)
...
def run_transformer_block(
    ...
    """
    return transformer_block.run_transformer_block(d_model, num_heads, d_ff, attn_pdrop, residual_pdrop, weights, in_features)
...
def run_transformer_lm(
    ...
    """
    return Transformer_LM.run_transformer_lm(vocab_size, context_length, d_model, num_layers, num_heads,
...
def run_rmsnorm(
    ...
    """
    return RMSNorm.run_rmsnorm(d_model, eps, weights, in_features)
...
def run_gelu(in_features: torch.FloatTensor) -> torch.FloatTensor:
    ...
    """
    return positionwise_feedforward.run_gelu(in_features)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float):
    ...
    Returns:
        None
    """
    return utils.run_gradient_clipping(parameters, max_l2_norm)
...
def get_tokenizer(
    ...
    return BPETokenizer.BPETokenizer(vocab, merges, special_tokens=special_tokens)
    ...
    Returns:
        Tuple of (vocab, merges):
            ...
            merges: list[tuple[bytes, bytes]]
                ...
                ["<unk>", "<pad>", "<s>", "</s>"]
    """
    return tokenizer_train.run_train_bpe(input_path, vocab_size=vocab_size, special_tokens=special_tokens, **kwargs)
